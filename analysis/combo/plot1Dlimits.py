...
def run(model,m1,res,lumi):
  ...
  m2 = [1, 10, 100, 1000] #ie ctau values
  wgt = 1 
  ...
  limitPlotObs.SetMinimum(0.0001)
  ...
  CMS_lumi(c,4,0,"2.6")
  c.RedrawAxis() 
  c.Print("~/www/Plots/DispJets/GenStudies/Limits/lim1D_m"+m1+"_r"+res+"_L"+lumi+".pdf")
  c.Print("~/www/Plots/DispJets/GenStudies/Limits/lim1D_m"+m1+"_r"+res+"_L"+lumi+".png")
